                    ...
                    <div class="header_top_bar_content">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-3 social">
                            <div class="header-top-search">
                               ...
                               <input name="s" id="s"  placeholder="Search" value="<?php the_search_query(); ?>" type="search">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-3 logo">
                            <a href="<?php echo esc_html(home_url()) ; ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/logo.png" alt=""></a>
